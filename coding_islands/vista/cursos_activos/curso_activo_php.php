...
require_once "../../modelo/class_includes.php";
	...
	if ( isset($_POST['respuesta']) ){
		...
		$cursos->control_respuesta_puntuacion_lecciones($p_pregunta, $p_respuesta, $_SESSION['session_usuario'], $p_nombre_curso = 'PHP');

		exit();	

	}else{

		$cursos->control_cursos_lecciones_registro($nombre_curso = 'PHP', $_SESSION['session_usuario']);

		$includes = new Includes();
		$includes->includes_header($title = 'Coding Islands || PHP', $link_css = '../content/css/cursos_activos.css');
		require_once "../templates/cursos_activos/curso_activo_php.tpl";
